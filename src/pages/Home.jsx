        ...
        <div className="hero-inline">
            ...
            <div className="hero-right-stacked">
                ...
                <div className="content-box">
                    ...
                    <p>What uVisbile aims for is making the lives of women easier through its calendar-tracking system. Family members will be able to see tasks which needed to be done, which aren’t always accounted for. Tasks include walking the dog, doing the dishes and dropping the kids off at soccer practice.</p>
